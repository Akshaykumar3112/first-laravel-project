...
<section class="content">
    ...
    <div class="box box-widget widget-user">
					...
					<div class="widget-user-image">
					  <img class="rounded-circle" src="{{(!empty($adminData->profile_photo))?url(asset('images/admin_images/'.$adminData->profile_photo)) : url(asset('backend/images/avatar/avatar-1.png'))}}" alt="User Avatar">
					</div>
