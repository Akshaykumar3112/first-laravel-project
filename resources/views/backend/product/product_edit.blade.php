                                    ...
                                    <div class="controls">                               
                                        <select name="subsubcategory_id" class="form-control">
                                            @foreach($subsubcategories as $subCat)
                                                @if($subCat->subcategory_id == $product->subcategory_id)
                                                    <option value="{{$subCat->id}}" {{$subCat->id == $product->subsubcategory_id ? 'selected':''}}  >{{$subCat->subsubcategory_name}} </option>
                                                    @endif
                                            @endforeach 
                                        </select>                               
                        ...
                        <div Class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ...
                                    <img src="{{$product->product_thambnail ? asset($product->product_thambnail) : ''}}" id ="mainThamb" width="80px" height="80px"> 
                                </div>
                            </div>
                        </div>
                        <div Class="col-md-6">
                            <h5>Product Images <span class="text-danger">*</span></h5>
                                <div class="controls">
                                    ...
                                    <div class="row" id ="preview_img"> 
                                        @foreach($multiImgs as $imgs)
                                        <a href="{{route('delete.multImage',$imgs->id)}}" id="delete" >
                                            <img src="{{asset($imgs->photo_name)}}" height="80px" width="80px" style="margin-right:10px;" data-bs-toggle="tooltip" tooltip-color="blue" data-bs-placement="top" title="Delete" >
                                        </a>
                                            @endforeach                                                                                                                
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="controls">
                                    <fieldset>
                                        <input type="checkbox" name="hot_deals" id="checkbox_2" {{$product->hot_deals == 1 ? 'checked': ''}} value="1">
                                        <label for="checkbox_2">Hot Deals</label>
                                    </fieldset>
                                    <fieldset>
                                        <input type="checkbox" name="featured" id="checkbox_3" {{$product->featured == 1 ? 'checked': ''}} value="1">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="controls">
                                    <fieldset>       
                                        <input type="checkbox" name="special_offer" id="checkbox_4" {{$product->special_offer == 1 ? 'checked': ''}}  value="1">
                                        <label for="checkbox_4"> Special Offer</label>
                                    </fieldset>
                                    <fieldset>
                                        <input type="checkbox" name="special_deals" id="checkbox_5" {{$product->special_deals == 1 ? 'checked': ''}} value="1">
                    ...
                    <div class="row">
                        <div Class="col-md-4">
                            <div class="form-group">
                                <div class="controls">
                                    <fieldset>
                                        <input type="checkbox" id="checkbox_6" name="status" {{$product->status == 1 ? 'checked': ''}}  value="1">
                ...
                $.each(data, function(index,file){
                    if(/(\.|\/)(gif|jpe?g|png)$/i.test(file.type)){
                        ...
                        fRead.onload = (function(file){
                            return function(e){                   
                                var img = $('<img style="margin-right:10px;"/>').addClass('thumb').attr('src' , e.target.result).width(80).height(80);
